...
from baselines.herCurrentGoalInput.util import (
    import_function, store_args, flatten_grads, transitions_in_episode_batch)
from baselines.herCurrentGoalInput.normalizer import Normalizer
from baselines.herCurrentGoalInput.replay_buffer import ReplayBuffer
...
class DDPG(object):
    ...
    def __init__(self, input_dims, buffer_size, hidden, layers, network_class, polyak, batch_size,
        ...
        Args:
            ...
            network_class (str): the network class that should be used (e.g. 'baselines.herCurrentGoalInput.ActorCritic')
        ...
        stage_shapes['ag'] = stage_shapes['g']
        for key in ['o', 'g', 'ag']:
    ...
    def get_actions(self, o, ag, g, noise_eps=0., random_eps=0., use_target_net=False,
        ...
        _, ag = self._preprocess_og(o, ag, ag)  # clip observations and goals
    ...
    def sample_batch(self):
        ...
        _, transitions['ag'] = self._preprocess_og(o, ag, ag)
        _, transitions['ag_2'] = self._preprocess_og(o_2, ag_2, ag_2)
